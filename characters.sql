...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-09-2024 a las 01:22:39
...
--
CREATE DATABASE IF NOT EXISTS `dragonball` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dragonball`;
...
('root', 'characters', 'table', 'dragonball', '');
...
('root', '[{\"db\":\"dragonball\",\"table\":\"characters\"}]');
...
('root', '2024-09-25 23:22:27', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
